...
<div class="container-fluid">
  ...
  <?php echo form_open('Edit_enveloppe_controller/add_env','class="form-horizontal"'); ?>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-lg-2 col-lg-pull-0">
      <a href=<?php echo site_url("Edit_enveloppe_controller/index");?>><button  type="button" class="btn btn-default btn-lg"  value="Reprendre la saisie"><span class="glyphicon glyphicon-floppy-remove"></span> Annuler/Cancel</button></a>
    </div>
  </div>
  <!-- /.row no-gutters -->
      ...
      <div class="panel panel-primary">
        <div class="panel-body">
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-11">
              <input id="DAE" onClick="EMS.disabled = true;" class="form-control" type="text" name="TBU_EMS" value="<?php echo set_value('TBU_EMS'); ?>">
            </div>
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-11">
              <input id="EMS" onClick="DAE.disabled = true;" class="form-control" type="text" name="TBU_EMS" value="<?php echo set_value('TBU_EMS'); ?>">
            </div>
            <h6 align="center">(Site/Unité)/(Place/Unit)</h6>
          </div>
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-11">
              <input placeholder="Obligatoire" class="form-control" type="text" name="Nom_Dem" value="<?php echo set_value('Nom_Dem'); ?>">
            </div>
          </div>
          <div class="form-group form-group-sm">
            <label class="control-label  "for="LIEUX_DEPOSE">Service /Department</label>
            <div class="col-sm-11">
              <input placeholder="Obligatoire" class="form-control" type="text" name="LIEUX_DEPOSE" value="<?php echo set_value('LIEUX_DEPOSE'); ?>">
            </div>
          </div>
          <div class="form-group form-group-sm">
            <label class="control-label  "for="Tel_Dem">Téléphone/Phone</label>
            <div class="col-sm-11">
              <input placeholder="Obligatoire" class="form-control" type="text" name="Tel_Dem" value="<?php echo set_value('Tel_Dem'); ?>">
            </div>
          </div>
          <div class="form-group form-group-sm">
            <label class="control-label  "for="DATE_DEPOSE">Date dépose / Removal date</label>
            <div class="col-sm-11">
              <input placeholder="Obligatoire" class="form-control" type="text" name="DATE_DEPOSE" value="<?php echo set_value('DATE_DEPOSE'); ?>">
            </div>
          </div>
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-11">
              <input placeholder="Obligatoire" class="form-control" type="text" name="N_CER" value="<?php echo set_value('N_CER'); ?>">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="panel panel-primary">
        <div class="panel-body">
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-11">
              <input placeholder="Obligatoire" class="form-control" type="text" name="PROGRAMME" value="<?php echo set_value('PROGRAMME'); ?>">
            </div>
          </div>
          <div class="form-group form-group-sm">
          ...
          <div class="form-group form-group-sm">
            <label class="control-label" for="PN_SRU">Référence DAE/DAE Reference</label>
            <div class="col-sm-11">
              <input class="form-control" type="text" name="PN_SRU" value="<?php echo set_value('PN_SRU'); ?>">
            </div>
          </div>
          <div class="form-group form-group-sm">
            <label class="control-label "for="SN_SRU">N° de série/Serial Number</label>
            <div class="col-sm-11">
              <input class="form-control" type="text" name="SN_SRU" value="<?php echo set_value('SN_SRU'); ?>">
            </div>
          </div>

          <hr style="width: 80%; color: black; height: 3px; background-color:black;" />
          <h6 align="center"> <strong>Composant/Component </strong></h6>
          <div class="form-group form-group-sm">
          ...
          <div class="form-group form-group-sm">
            ...
            <div class="col-sm-11">
              <input placeholder="Mettre un X en cas d'information indisponible"class="form-control" type="text" name="DATE_CODE" value="<?php echo set_value('DATE_CODE'); ?>">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="panel panel-primary">
          <div class="panel-body">
            ...
            <div class="form-group form-group-sm">
              <div class="col-lg-11">
                <select id="devermin" onClick="detect.disabled = true;" class="form-control" name="deverminage"value="<?php echo set_value('deverminage'); ?>">
                  <option value=""></option>
            ...
            <div class="form-group form-group-sm">
              <div class="col-lg-11">
                <select id="detect" onClick="devermin.disabled = true;" class="form-control" name="typdetect" value="<?php echo set_value('typdetect'); ?>">
                  <option value=""></option>
      ...
      <div class="col-lg-6" >
        <div class="panel panel-primary" >
          <div class="panel-body" >
            ...
            <div class="form-group form-group-sm">
              <div class="col-lg-5">
                <label  class="form-control" for="Vibration" >Vibration</label>
                <select class="form-control" name="Vibration" value="<?php echo set_value('Vibration'); ?>">
                  <option value=""> </option>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-lg-4">
                <textarea class="form-control" rows="2" cols="55" name="comment_comp" value="<?php echo set_value('comment_comp'); ?>"></textarea>
              </div>
            </div>
            ...
            <div class="form-group form-group-sm ">
              ...
              <div class="col-lg-4 ">
                <textarea class="form-control" rows="2" cols="55" name="comment_brasure" value="<?php echo set_value('comment_brasure'); ?>"></textarea>
              </div>
            </div>
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-lg-4 ">
                <textarea class="form-control" rows="2" cols="55" name="comment_env" value="<?php echo set_value('comment_env'); ?>"></textarea>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="panel panel-primary">
            ...
            <div class="form-group form-group-sm">
              ...
              <div class="col-lg-6 ">
                ...
                <div class="col-lg-8">
                  <textarea class="form-control" row ="4" cols="65" name="COMMENTAIRES"></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="form-group form-group-sm">
              <div class="col-lg-4 offset-md-4">
                <label class="control-label" for="N_Enveloppe">N°Enveloppe</label><br>
                <div class="col-lg-5">
                </div>
              </div>
            </div>
      ...
      <div class="panel panel-primary">
        <div class="panel-body">
          <div class="form-group form-group-sm">
            ...
            <div class="col-lg-7">
              <input placeholder="Obligatoire" class="form-control" type="text" name="NomRPS" value="<?php echo set_value('NomRPS'); ?>">
            </div>
          </div>
          <div class="col-lg-9">
            <div class="form-group form-group-sm">
              ...
              <label for="DEC_EXP"class="checkbox-inline">
                <input placeholder="Obligatoire" class=" inputsm" type="checkbox"  name="DEC_EXP"value="oui">Oui <br>Yes
              </label>
              <label for="DEC_EXP" class="checkbox-inline">
  ...
  <div class="row no-gutters ">
    <div class="col-lg-4">
      <div class="panel panel-primary">
        <div class="form-group form-group-sm">
          <label class="control-label col-lg-10 "for="reponse_fast">Réservé à l'expertise,réponse rapide./Reserved for analysis,quick answer </label>
          <div class="col-lg-9"><br>
            <textarea class="form-control" name="reponse_fast" row ="3" cols="45"></textarea>
          </div>
        </div>
      </div>
    </div>
