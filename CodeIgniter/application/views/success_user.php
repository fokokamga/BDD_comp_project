      ...
      <div class="modal-body text-center">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <div class="alert alert-success">
            <strong>CONNEXION REUSSIE / LOGIN SUCCESS</strong><br>
            <br><br><br><br>

              <a href=<?php echo site_url("view_env_controller/index");?>><button  type="button" class="btn btn-default btn-md"  value="Reprendre la saisie"><span class="glyphicon glyphicon-list-alt"></span> Voir Enveloppe saisies</button></a>


              <a href=<?php echo site_url("Edit_enveloppe_controller/index");?>><button  type="button" class="btn btn-default btn-md"  value="Reprendre la saisie"><span class="glyphicon glyphicon-edit"></span> Effectuer une nouvelle dépose</button></a>
